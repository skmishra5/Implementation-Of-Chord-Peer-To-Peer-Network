...
public class FileTransferRequest implements Event{
	...
	public String getInfo(){ return String.valueOf(predNodeID); }
	public int getForwardFlag(){ return -1; }
	public int getFingerTableEntry(){ return -1; }
	
	public byte[] fileTransferRequestMessage(int nodeID, String IP, int listenPort, int pNodeID) throws IOException
	{
		type = Protocol.FILE_TRANSFER_REQUEST;
		Date dte=new Date();
