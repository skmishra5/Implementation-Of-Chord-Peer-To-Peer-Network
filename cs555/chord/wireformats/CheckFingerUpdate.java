...
public class CheckFingerUpdate implements Event{
	private int type;
	...
	public byte[] checkFingerUpdateMessage(int nodeID, String IP, int listenPort, int fingTblEntry) throws IOException
	{
		type = Protocol.CHECK_FINGER_UPDATE;
		Date dte=new Date();
