...
public class UpdateLookUpAfterEntryRequest implements Event{
	private int type;
	private long timestamp;
	private int m_nodeID;
	private String IPAddress;
	private int listenPortNumber;
	private int fingerTableEntry;
	...
	public int getFingerTableEntry(){ return fingerTableEntry; }
	
	public byte[] updateLookUpAfterMessage(int nodeID, String IP, int listenPort, int fingTblEntry) throws IOException
	{
		type = Protocol.UPDATE_LOOKUP_AFTER_ENTRY;
		Date dte=new Date();
	    timestamp = dte.getTime();
	    m_nodeID = nodeID;
	    IPAddress = IP;
	    listenPortNumber = listenPort;
	    fingerTableEntry = fingTblEntry;
	...
	public byte[] getBytes() throws IOException {		
		...
		dout.writeInt(fingerTableEntry);
