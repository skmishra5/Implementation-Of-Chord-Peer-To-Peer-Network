...
public class UpdateLookUpAfterEntryResponse implements Event{
	private int type;
	...
	public byte[] updateLookUpAfterEntryResponseMessage(String nodeInfo, int entry) throws IOException
	{
		type = Protocol.UPDATE_LOOKUP_AFTER_ENTRY_RESPONSE;
		Date dte=new Date();
